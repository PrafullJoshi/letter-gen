package in.co.parna.lettergen.configuration;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)//
                ...
                .globalOperationParameters(buildHeadersAsOperationsParameters())
    ...
    private ArrayList<Parameter> buildHeadersAsOperationsParameters() {
        ArrayList<Parameter> parameters = new ArrayList<>();
        Parameter authHeader = new ParameterBuilder()
                .name("Authorization")
                .description("Authorization token to be passed as header")
    ...
    private ArrayList<SecurityContext> getSecurityContexts() {
        ...
        securityContexts.add(SecurityContext.builder().forPaths(PathSelectors.regex(".*/secure/.*")).build());
    ...
    private List<ResponseMessage> getResponseMessages() {
        ...
        responseMessages.add(new ResponseMessageBuilder().code(422).message("Incorrect Entity Data").build());
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder()
                ...
                .description("This is list of APIs supported. Needs jwt token for authorized APIs")
                .version("1.0.0")
                // .license("MIT License").licenseUrl("http://opensource.org/licenses/MIT")//
                .contact(new Contact(null, null, "prafull.joshi@gmail.com"))//
                .build();
    }
}
